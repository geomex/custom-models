...
schema = {"race": "object", "gender": "object", "age": "object",
          ...
          "discharge_disposition_id": "object", "admission_source_id":
          "object", "time_in_hospital": "int64", "payer_code":
          "object", "medical_specialty": "object",
          "num_lab_procedures": "int64", "num_procedures": "int64",
          "num_medications": "int64", "number_outpatient": "int64",
          "number_emergency": "int64", "number_inpatient": "int64",
          "number_diagnoses": "int64", "max_glu_serum": "object",
          "A1Cresult": "object", "metformin": "object", "repaglinide":
          "object", "nateglinide": "object", "chlorpropamide":
          "object", "glimepiride": "object", "acetohexamide":
          "object", "glipizide": "object", "glyburide": "object",
          "tolbutamide": "object", "pioglitazone": "object",
          "rosiglitazone": "object", "acarbose": "object", "miglitol":
          "object", "troglitazone": "object", "tolazamide": "object",
          "examide": "object", "citoglipton": "object", "insulin":
          "object", "glyburide_metformin": "object",
          "glipizide_metformin": "object", "glimepiride_pioglitazone":
          "object", "metformin_rosiglitazone": "object",
          "metformin_pioglitazone": "object", "change": "object",
          "diabetesMed": "object"}
...
def read_input_data(input_binary_data):
    ...
    data.drop(["id", 'diag_1', 'diag_2', 'diag_3'],axis=1,inplace=True) 
    data.drop(['diag_2_desc', 'diag_3_desc'], axis=1, inplace=True)   
...
def fit(
    ...
    **kwargs,
    ...
    X.drop(['id', 'diag_1', 'diag_2', 'diag_3'],axis=1,inplace=True)
    X = X.astype(schema)
    ...
    model = XGBClassifier(colsample_bylevel=0.2, max_depth= 10,
...
def post_process(predictions,model):
    ...
    def legacy_score(row):
        try:
            return expit(0.59 + 0.55 * row['number_inpatient'] + 0.36
                         * row['number_outpatient'])
        except:
            return 0.38

    predictions['True_legacy'] = original_data.apply(lambda row:
                                                     legacy_score(row), axis=1)
    predictions['True'] = (predictions['True'] +
                           predictions['True_legacy'])
